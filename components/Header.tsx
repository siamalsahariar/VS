...
const Header = () => {
  ...
  function xn() {
    let { leftNavState: e = "closed" } = document.body.dataset;
    document.body.dataset.leftNavState = "open" === e ? "closed" : "open";
  }
  ...
  return (
    <>
      <header className="crayons-header fixed-header print-hidden">
        ...
        <div className="crayons-header__container">
          ...
          <Link href="/" className="site-logo" aria-label="DEV Community Home">
      ...
      >
        <div className="hamburger__content">
          <div className="hamburger__content__header">
            ...
            >
              <svg
                ...
                className="crayons-icon c-btn__icon"
              >
                <title id="alzc7o4g3utnd566rc10wc37id48xjp0">Close</title>
            ...
            <div>
              ...
              <div className="flex justify-start mb-4">
                ...
                >
                  ...
                  >
                    <title id="ai116q82v7rg5xa356xwu6gk621y01an">Twitter</title>
                ...
                >
                  <svg
                    ...
                    className="crayons-icon c-link__icon"
                  >
                    <title id="ajlgwxfsq3iia4pnxdca9ymmiw8zfrds">
                      Facebook
                    </title>
                ...
                >
                  <svg
                    ...
                    className="crayons-icon c-link__icon"
                  >
                    <title id="an5v7x99k4mtamsjhwrplkiir1tvcgrv">Github</title>
                ...
                >
                  <svg
                    ...
                    className="crayons-icon c-link__icon"
                  >
                    <title id="ar9kcfjaw6iat21bad9cg6immc3i1u3l">
                      Instagram
                    </title>
                ...
                >
                  <svg
                    ...
                    className="crayons-icon c-link__icon"
                  >
                    <title id="al7hwf99q7nvv59iwexjjpkd6u5mwob8">Twitch</title>
                ...
                >
                  <svg
                    ...
                    className="crayons-icon c-link__icon"
                  >
                    <title id="aaklodp0dsqms3lp1fgtm2gmfdria6jp">
                      Mastodon
                    </title>
        ...
        <div id="overlay" className="hamburger__overlay"></div>
      </div>
    </>
  );
};

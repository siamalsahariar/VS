          ...
          <div className="registration-providers">
            ...
            <form className="flex w-100">
              ...
              <input
                ...
                value="vRVwkPjiRWz_j2hTfdtUY7930a0DoDa07SKBpZGzpiROwwix8d8SnRm8XrMwUQP1-dcfJGwyC40hzj27Q6zm7w"
                autoComplete="off"
              />
              <button
                name="button"
            ...
            <form className="flex w-100">
              ...
              <input
                type="hidden"
                name="authenticity_token"
                value="T9Ev-B6xJPqIHIqmA1Gj5MUso6g9_N3RPo-1p9eJaRO8B1fZF4xzC24vvEZO2_Ryg4xtIVJu4OjyYwm5BZYp2A"
                autoComplete="off"
              />
              <button
                name="button"
          ...
          <div className="registration__actions-email">
            ...
            <form className="new_user">
              <div className="crayons-field mb-3">
                <label className="crayons-field__label" htmlFor="user_email">
                  Email
                </label>
                <input
                  autoComplete="email"
              ...
              <div className="crayons-field mb-3">
                <label className="crayons-field__label" htmlFor="user_password">
                  Password
                </label>
                <input
              ...
              <div className="crayons-field crayons-field--checkbox inline-flex flex-row items-center">
                ...
                />
                <label
                  className="crayons-field__label fw-normal"
              ...
              <div className="actions pt-3">
                <input
                  ...
                  name="commit"
                  value="Continue"
                  className="crayons-btn continue crayons-btn--l w-100"
